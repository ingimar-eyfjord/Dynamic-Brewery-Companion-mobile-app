    ...
    return (
        <div className="cartpage">
            ...
            <div className="cartBtns">
                ...
                <Link to="/home"><button className="continueback" style={mapped.length === 0 ? { backgroundColor: "var(--orange)" } : { backgroundColor: "transparent", border: "solid", borderColor: "black", borderWidth: "1px", color: "black" }}>Continue Shopping</button></Link>
            </div>
        </div>
    )
